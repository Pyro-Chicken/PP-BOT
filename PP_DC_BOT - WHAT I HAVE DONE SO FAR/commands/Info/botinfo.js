...
let e = new Discord.MessageEmbed()
    ...
    .addField("Support", "Type '+help info' in chat and pay attention to the first command listed to contact me! NOTE: Any innapropriate use of this command, such as spam or innapropriate or invalid reasoning, will result in a blacklist from this bot! **You shall only recieve 1 warning!**")
